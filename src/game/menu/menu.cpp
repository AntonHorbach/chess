...
bool Menu::init(SDL_Renderer* renderer, int x, int y, int width, int height,
...
bool Menu::setButtonsTextures(const std::string& buttonOn_sprite, const std::string& buttonOFF_sprite)
{
    ...
    if(buttonOff == nullptr || buttonOn == nullptr) return false;
